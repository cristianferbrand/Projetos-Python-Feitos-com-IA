...
python monitor_cloud_backup_WEB_BROWSER.py --web --host 127.0.0.1 --port 8550 --view BROWSER
"""
import os
import sys
import json
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=int, default=8550, help="Porta do servidor web (padrão: 8550)")
