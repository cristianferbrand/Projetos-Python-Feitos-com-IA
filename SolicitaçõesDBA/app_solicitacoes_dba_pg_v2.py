    ...
    def _chat_view(self, rid: int) -> Optional[ft.View]:
            ...
            def _restore_kb():
                ...
                try:
                    ...
                    self.page.on_keyboard_event = _prev_kb
            ...
            appbar = ft.AppBar(
                leading=ft.IconButton(I.ARROW_BACK, on_click=lambda _:( _restore_kb(), self.page.go("/") )),
        ...
        # Helpers para abrir/baixar anexos usando métodos já existentes na classe
            ...
            # Input + enviar
            # Campo de mensagem (multilinha: Shift+Enter quebra; Enter envia via atalho)

            inp_msg = ft.TextField(
label="Mensagem",

                hint_text="Enter envia • Shift+Enter quebra linha",
...
# Atalhos de teclado do chat: Enter envia, Shift+Enter quebra linha


            chat_kb_active = False


            def _on_focus(_):


                nonlocal chat_kb_active
            ...
            inp_msg.on_focus = _on_focus


            inp_msg.on_blur = _on_blur
            ...
            def _kb(e: ft.KeyboardEvent):
                ...
                # Age somente quando o foco está no campo de mensagem


                if not chat_kb_active:
                ...
                if e.key == 'Enter' and not (e.shift or e.ctrl or e.alt or e.meta):


                    try:


                        inp_msg.value = (inp_msg.value or '').rstrip('\r\n')
            ...
            # Guarda handler anterior e instala o do chat


            _prev_kb = getattr(self.page, 'on_keyboard_event', None)
