# -*- coding: utf-8 -*-
"""
Organizador de Arquivos SPED (Flet) - AUTO-DETECÇÃO + MONITOR + PASTA POR CLIENTE
----------------------------------------------------------------------------------
...
class OrganizadorSPED:
    ...
    def build(self) -> ft.Control:
        ...
        header = ft.Row([
            ...
            ft.Text("Organizador de Arquivos SPED (Auto por Tipo + Cliente)", size=20, weight=ft.FontWeight.BOLD),
...
def main(page: ft.Page):
    page.title = "AuditHOS • Organizador SPED (Auto por Tipo + Cliente)"
